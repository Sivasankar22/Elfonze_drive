...
public class ApplicantController {
    ...
    JobsServices jobsServices;
        ...
        public ResponseEntity<String> addApplicant(@RequestParam("resumeFile") MultipartFile resumeFile, @RequestBody AddApplicantRequest addApplicantRequest) {
            try {
                log.info("Received request: {}", addApplicantRequest.toString());
                String result = applicantServices.addApplicant(addApplicantRequest, resumeFile);
