...
public class SuperAdminController {
    ...
    public ResponseEntity<String> addAdmin(@RequestBody AddAdminRequest addAdminRequest,@RequestParam("SuperAdminName") String SuperAdminName) {

        try {
            log.info("We have request : {}", addAdminRequest.toString());
            String result = superAdminServices.addAdminBySuperAdmin(addAdminRequest,SuperAdminName);
...
//    }
    @PutMapping("/Approval")
    public ResponseEntity<String> Approval(@RequestParam("AdminName") String AdminName,@RequestParam("SuperAdminName") String SuperAdminName) throws Exception {

        String result = superAdminServices.approveAdmin(AdminName,SuperAdminName);
        return new ResponseEntity<>(result, HttpStatus.OK);
