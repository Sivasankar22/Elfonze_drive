...
public class ApplicantServices {
    ...
    public String addApplicant(AddApplicantRequest addApplicantRequest, MultipartFile resumeFile) throws Exception {
        // Convert the AddApplicantRequest to an Applicant object
        Applicant newUser;
        try {
            newUser = ApplicantTranforms.convertAddApplicantReqToApplicant(addApplicantRequest, resumeFile);
        } catch (IOException e) {
